...
/**
  ...
  * @param domElement the HTMLDOMElement used to listen for mouse / touch events.
  * This must be passed in the constructor; changing it here will not set up new event listeners.
  */
@js.native
@JSImport(
