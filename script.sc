...
doricColumn(xyz(0, 0), 9, 0.5, 0.4, 0.3, 0.3, 1.0)
doricColumn(xyz(3, 0), 7, 0.5, 0.4, 0.6, 0.6, 1.6)
doricColumn(xyz(6, 0), 9, 0.7, 0.5, 0.3, 0.2, 1.2)
doricColumn(xyz(9, 0), 8, 0.4, 0.3, 0.2, 0.3, 1.0)
doricColumn(xyz(12, 0), 5, 0.5, 0.4, 0.3, 0.1, 1.0)
doricColumn(xyz(15, 0), 6, 0.8, 0.3, 0.2, 0.4, 1.4)
