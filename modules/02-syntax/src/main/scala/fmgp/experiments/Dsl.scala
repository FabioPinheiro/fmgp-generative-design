...
// (init: (fmgp.geo.Dsl.Warp | fmgp.geo.Dsl.Dummy) ?=> fmgp.geo.Shape | Unit)(using ctx: fmgp.geo.Dsl.Warp | fmgp.geo.Dsl.Dummy): Matchable
// (init: (fmgp.geo.Dsl.Warp) ?=> fmgp.geo.Shape | Unit)  (using ctx: fmgp.geo.Dsl.Warp | fmgp.geo.Dsl.Dummy): fmgp.geo.ShapeSeq match arguments (fmgp.geo.Shape | Unit)
