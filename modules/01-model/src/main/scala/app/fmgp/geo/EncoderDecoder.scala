...
object EncoderDecoder {
  ...
  given Decoder[Dimensions] = new Decoder[Dimensions] { 
    override def apply(c: io.circe.HCursor): io.circe.Decoder.Result[Dimensions] = c.as[String].map(Dimensions.valueOf(_)) 
  }
  ...
  given Encoder[Matrix] = new Encoder[Matrix]:
    override def apply(a: Matrix): io.circe.Json = summon[Encoder[Array[Double]]](
      Array(a.m00, a.m01, a.m02, a.m03, a.m10, a.m11, a.m12, a.m13, a.m20, a.m21, a.m22, a.m23, a.m30, a.m31, a.m32, a.m33)
    )
  ...
  given Decoder[Coordinate3D] = new Decoder[Coordinate3D]:
    override def apply(c: io.circe.HCursor): io.circe.Decoder.Result[Coordinate3D] = summon[Decoder[Coordinate]](c).map(_.asInstanceOf[Coordinate3D])
