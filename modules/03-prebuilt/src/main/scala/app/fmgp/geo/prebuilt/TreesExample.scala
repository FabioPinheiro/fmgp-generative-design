...
object TreesExample {
  ...
  type ZOUT = UIO[app.fmgp.geo.Shape]
  ...
  def tree2d(
      ...
      iterations: Int = 6,
      leafRadius: Double = 0.1
  ): URIO[Has[Tree], app.fmgp.geo.Shape] = ZIO.serviceWith(
  ...
  val program: zio.ZIO[zio.Has[Tree] with zio.Has[Dsl], Throwable, app.fmgp.geo.Shape] = {
    for {
